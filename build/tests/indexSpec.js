...
describe('Test endpoint responses', () => {
    ...
    it("should throw error if get correct data from the user", () => __awaiter(void 0, void 0, void 0, function* () {
...
// })
// describe("get false data data from user",()=>{
//     it("should throw error if get correct data from the user",()=>{
//     })
//})
